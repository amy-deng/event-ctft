...
try:
    ...
    print("usage: <out_path> <dataset_name `THA_topic`> <raw_data_name `raw_w10h7`> <event_code 1-20>")
    exit()
...
outcome = dataset['outcome'][:,:,event_id].sum(1) # number of events; sum of all days
# not binary vector
outcome_sep_day = dataset['outcome'][:,:,event_id] # number of events; sum of all days
print('data loaded')
