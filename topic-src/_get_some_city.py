...
import pickle
import numpy as np
with open('../RUS_w7h7_mind3n10df0.01/causal_topics_0.01.pkl','rb') as f:
    d=pickle.load(f)

l = []
for k in ['2014-01-01', '2014-04-01', '2014-07-01', '2014-10-01', '2015-01-01', '2015-04-01', '2015-07-01', '2015-10-01', '2016-01-01', '2016-04-01', '2016-07-01', '2016-10-01', '2017-01-01', '2017-04-01']:
    l.append(d[k].sum(-1).nonzero()[0].shape[0])
