...
'''
python build_causal_samples_w_time_nocheck.py ../data THA_topic check_topic_causal_data_w7h7
python build_causal_samples_w_time_nocheck.py ../data THA_topic check_topic_causal_data_w7h14
